...
ax.set_title("Figure III.6 — Effet de la couverture des conditions sur la fiabilité")
fig.tight_layout()
...
ax.set_title("Figure III.7 — Importance des variables explicatives")
fig.tight_layout()
...
ax.legend(fontsize=8)
ax.set_title("Figure III.9 — Vitrine 30 °C vs contre-exemples (facteur non contrôlé)")
fig.tight_layout()
